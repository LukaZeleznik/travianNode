...
const reportSchema = new Schema ({
        ...
        idVillageSender:    { type: String, required: true },
        idVillageReceiver:  { type: String, required: true },
        tribeSender:        { type: String, required: true },
        tribeReceiver:      { type: String, required: true },
        mailboxUserId:      { type: String, required: true },
        readFlag:           { type: Number, required: true },
